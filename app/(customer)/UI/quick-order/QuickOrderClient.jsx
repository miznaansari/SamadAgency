...
const ProductRow = React.memo(function ProductRow({
  ...
  return (
    <tr className="border-b border-gray-300 odd:bg-white even:bg-[#F3F8FB]">
      ...
      <td className="border border-gray-300 font-semibold px-3 text-[#8A8A8A]">{product.sku ?? "—"}</td>
      ...
      <td className="border border-gray-300 px-2  text-center font-semibold">
        {loadingDetails ? (
        ...
        <table className="w-full md:table-fixed border text-sm mt-0">
          <thead className="bg-gray-100 z-20 text-gray-800 md:sticky md:top-16 md:w-full">
            <tr>
              ...
              <th className="border border-gray-300 px-3 py-2 text-left md:w-[170px]">
                Product Code
              </th>

              {/* FLEX COLUMN */}
              <th className="border border-gray-300 px-3 py-2 text-left md:w-full">
                Product Name
              </th>

              <th className="border border-gray-300 px-3 py-2 text-center md:w-[90px]">
                Unit
              </th>

              <th className="border border-gray-300 px-3 py-2 text-center md:w-[160px]">
                Unit Price (Ex GST)
              </th>

              <th className="border border-gray-300 px-3 py-2 text-center md:w-[80px]">
                QTY
              </th>

              <th className="border border-gray-300 px-3 py-2 text-center md:w-[120px]">
                Wishlist
              </th>
            </tr>
          </thead>
