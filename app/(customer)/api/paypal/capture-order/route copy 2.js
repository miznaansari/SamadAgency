...
export async function POST(req) {
 ...
 // 🟡 SANDBOX PENDING TESTING (REMOVE IN PROD)
if (process.env.NODE_ENV === "development") {
  headers["PayPal-Mock-Response"] = JSON.stringify({
    mock_application_codes: "ORDER_PENDING_APPROVAL",
  });
}
    ...
    if (statusCode === 200 || statusCode === 201) {
      // ✅ success → continue
    } else if (statusCode === 422 && issue === "INSTRUMENT_DECLINED") {
      return failPayment({
        status: 422,
        body: {
          success: false,
      ...
      return failPayment({
        ...
        body: {
          ...
          retry: false,
          reason: issue,
          message: "Invalid PayPal request.",
        },
      });
      ...
      return failPayment({
        ...
        body: {
          ...
          reason: issue,
          message:
            "PayPal authorization failed. Merchant configuration issue.",
        },
      });
      ...
      return failPayment({
        ...
        body: {
          ...
          reason: issue,
          message:
            "PayPal service unavailable. Please try again later.",
        },
      });
    } else {
      return failPayment({
