export default function Loading() {
  return (
    <div className="bg-white m-2 rounded-xl border border-gray-200  animate-pulse">
      {/* ================= Header ================= */}
      ...
      {/* ================= DESKTOP TABLE ================= */}
      <div className="hidden md:block overflow-hidden border border-gray-200 rounded">
